  ...
  return (
    <header ref={heroSectionRef} className="hero-section h-screen bg-[#0f172a] overflow-hidden relative">
      <div className="parallax-viewport absolute inset-0">
        ...
        <div className="hero-content absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
          <div className="layer__header">
            <h1 ref={titleRef} className="layers__title text-6xl md:text-8xl lg:text-9xl font-black text-white text-center leading-none"
                style={{
